...
impl I18n {
    pub fn new(lang: Language) -> Self {
        ...
        translations.insert(
            "app_tagline",
            (
                "Forjando secretos seguros con age",
        ...
        translations.insert(
            "generated",
            (
                "✓ Secreto generado y copiado",
                "✓ Secret generated and copied",
            ),
        );
        translations.insert(
            "fav_added",
            ("⭐ Agregado a favoritos", "⭐ Added to favorites"),
        );
        translations.insert(
            "fav_removed",
            ("⭐ Removido de favoritos", "⭐ Removed from favorites"),
        );
        ...
        translations.insert(
            "error_decrypt",
            ("❌ Error al desencriptar", "❌ Error decrypting"),
        );
        translations.insert("error_regex", ("❌ Regex inválido", "❌ Invalid regex"));
        translations.insert(
            "error_empty_key",
            ("❌ La clave no puede estar vacía", "❌ Key cannot be empty"),
        );
        translations.insert(
            "error_no_key_match",
            ("❌ Ninguna llave coincide", "❌ No matching key"),
        );
        translations.insert(
            "error_decrypt_key",
            (
                "Error: No se pudo desencriptar con esta llave",
                "Error: Could not decrypt with this key",
            ),
        );
        ...
        translations.insert(
            "error_convert_key",
            (
                "Error al convertir llave privada a pública",
                "Error converting private key to public",
            ),
        );
        translations.insert(
            "error_save_config",
        ...
        translations.insert(
            "sops_initialized",
            ("✓ Archivo .sops.yaml creado", "✓ .sops.yaml file created"),
        );
        translations.insert(
            "sops_exists",
            ("⚠️ .sops.yaml ya existe", "⚠️ .sops.yaml already exists"),
        );
        translations.insert(
            "no_keys",
            (
                "❌ No hay llaves age disponibles",
                "❌ No age keys available",
            ),
        );
        translations.insert(
            "key_generated",
            ("✓ Nueva llave age generada", "✓ New age key generated"),
        );
        translations.insert("key_deleted", ("✓ Llave eliminada", "✓ Key deleted"));
        translations.insert(
            "key_manager_title",
            ("🔑 Gestor de Llaves Age", "🔑 Age Key Manager"),
        );
        translations.insert(
            "confirm_key_deletion",
            ("⚠️ Confirmar Eliminación", "⚠️ Confirm Deletion"),
        );
        translations.insert(
            "confirm_key_creation",
            ("✓ Crear Clave Age", "✓ Create Age Key"),
        );
        translations.insert(
            "no_keys_found",
            ("No se encontraron claves age", "No age keys found"),
        );
        translations.insert(
            "keys_file_missing",
            (
                "El archivo ~/.config/sops/age/keys.txt no existe.",
                "The file ~/.config/sops/age/keys.txt does not exist.",
            ),
        );
        translations.insert(
            "create_key_question",
            (
                "¿Deseas crear una nueva clave age?",
                "Do you want to create a new age key?",
            ),
        );
        translations.insert(
            "create_key_confirm",
            ("[y/s] Crear clave", "[y/s] Create key"),
        );
        translations.insert(
            "key_created",
            (
                "✓ Clave age creada exitosamente",
                "✓ Age key created successfully",
            ),
        );
        translations.insert(
            "confirm_key_creation_help",
            (
                "[y/s] Crear | [n/Esc] Cancelar",
                "[y/s] Create | [n/Esc] Cancel",
            ),
        );
        ...
        translations.insert(
            "key_manager_help",
            (
                "[↑↓] Navegar | [n] Nueva llave | [d] Eliminar | [Esc] Cerrar",
                "[↑↓] Navigate | [n] New key | [d] Delete | [Esc] Close",
            ),
        );
        translations.insert(
            "confirm_deletion_help",
            (
                "[y] Confirmar eliminación | [n] Cancelar",
                "[y] Confirm deletion | [n] Cancel",
            ),
        );
        ...
        translations.insert(
            "file_created",
            ("Archivo encriptado creado", "Encrypted file created"),
        );
        translations.insert("new_folder_title", ("📁 Nueva Carpeta", "📁 New Folder"));
        translations.insert(
            "new_file_title",
            ("🔐 Nuevo Archivo Encriptado", "🔐 New Encrypted File"),
        );
        translations.insert(
            "select_format_title",
        ...
        translations.insert(
            "press_search",
            ("Presiona [/] para buscar", "Press [/] to search"),
        );
        translations.insert(
            "search_cancel",
            ("Esc: cancelar, Enter: aplicar", "Esc: cancel, Enter: apply"),
        );
        ...
        translations.insert(
            "search_secret_regex",
            ("🔎 Buscar secreto [REGEX]", "🔎 Search secret [REGEX]"),
        );
        translations.insert(
            "search_secret_normal",
            ("🔍 Buscar secreto", "🔍 Search secret"),
        );
        translations.insert("search_key_title", ("🔍 Buscar llave", "🔍 Search key"));
        translations.insert(
            "keys_search_apply",
            (
                "[/: Buscar | Enter: Aplicar | Esc: Cancelar]",
        ...
        translations.insert(
            "scroll_json",
            (
                "[↑↓: scroll | j: toggle JSON]",
                "[↑↓: scroll | j: toggle JSON]",
            ),
        );
        translations.insert(
            "tab_switch",
            ("[Tab: cambiar campo]", "[Tab: switch field]"),
        );
        ...
        translations.insert(
            "add_secret",
            ("➕ Agregar Nuevo Secreto", "➕ Add New Secret"),
        );
        translations.insert(
            "modal_help",
            (
                "[Tab: cambiar campo | Enter: guardar | Esc: cancelar]",
                "[Tab: switch field | Enter: save | Esc: cancel]",
            ),
        );
        translations.insert(
            "confirm_delete",
            ("¿Eliminar este secreto?", "Delete this secret?"),
        );
        translations.insert("full_value", ("📄 Valor Completo", "📄 Full Value"));
        translations.insert(
            "value_help",
            (
                "[Esc/z: cerrar | ↑↓: scroll | j: toggle JSON]",
                "[Esc/z: close | ↑↓: scroll | j: toggle JSON]",
            ),
        );
        ...
        translations.insert(
            "cmd_key_manager",
            ("[K] Gestionar llaves", "[K] Manage keys"),
        );
        translations.insert("cmd_new_folder", ("[N] Nueva carpeta", "[N] New folder"));
        translations.insert(
            "cmd_new_file",
            ("[n] New secrets file", "[n] New secrets file"),
        );
        ...
        translations.insert(
            "footer_select_format",
            (
                "[↑↓] Navegar | [Enter] Continuar | [Esc] Cancelar",
        ...
        translations.insert(
            "no_keys_selected",
            (
                "Debes seleccionar al menos una llave",
                "You must select at least one key",
            ),
        );
        translations.insert(
            "sops_not_initialized",
            (
                "Primero inicializa SOPS con [i]",
                "First initialize SOPS with [i]",
            ),
        );
        translations.insert(
            "select_sops_keys_title",
            ("🔑 Seleccionar Llaves para SOPS", "🔑 Select Keys for SOPS"),
        );
        translations.insert(
            "footer_select_sops_keys",
            (
                "[↑↓] Navegar | [Espacio/Enter] Seleccionar | [Esc] Cancelar",
        ...
        translations.insert(
            "sops_saved",
            ("✓ .sops.yaml guardado", "✓ .sops.yaml saved"),
        );
        translations.insert(
            "select_template_title",
            ("📋 Seleccionar Template SOPS", "📋 Select SOPS Template"),
        );
        translations.insert(
            "template_simple",
            (
                "Por formato - .env/.json/.yaml/.ini",
                "By format - .env/.json/.yaml/.ini",
            ),
        );
        translations.insert(
            "template_simple_desc",
            (
                "Reglas separadas para cada tipo de archivo",
                "Separate rules for each file type",
            ),
        );
        translations.insert(
            "template_by_type",
        ...
        translations.insert(
            "template_by_type_desc",
            (
                "Diferentes llaves según el entorno",
                "Different keys based on environment",
            ),
        );
        translations.insert(
            "template_regex",
            (
                "Solo valores sensibles - encrypted_regex",
                "Sensitive values only - encrypted_regex",
            ),
        );
        translations.insert(
            "template_regex_desc",
            (
                "Encripta password, secret, key, token, etc.",
                "Encrypts password, secret, key, token, etc.",
            ),
        );
        translations.insert(
            "template_k8s",
            (
                "Kubernetes - data/stringData",
                "Kubernetes - data/stringData",
            ),
        );
        translations.insert(
            "template_k8s_desc",
            (
                "Para archivos YAML de Kubernetes (data/stringData)",
                "For Kubernetes YAML files (data/stringData)",
            ),
        );
        ...
        translations.insert(
            "selecting_key",
            ("Seleccionando llave...", "Selecting key..."),
        );
        ...
        translations.insert(
            "help_key_selector",
            ("🔑 Selector de Llaves", "🔑 Key Selector"),
        );
        ...
        translations.insert(
            "help_open_dir",
            (
                "Abrir carpeta o cargar archivo encriptado",
                "Open folder or load encrypted file",
            ),
        );
        translations.insert(
            "help_mark",
            (
                "Marcar/desmarcar archivo para operaciones",
                "Mark/unmark file for batch operations",
            ),
        );
        translations.insert(
            "help_init_sops",
            (
                "Crear archivo .sops.yaml en el directorio",
                "Create .sops.yaml file in directory",
            ),
        );
        translations.insert(
            "help_change_secrets",
            ("Ir al panel de secretos", "Go to secrets panel"),
        );
        translations.insert(
            "help_key_selector_open",
            ("Abrir selector de llaves age", "Open age key selector"),
        );
        translations.insert(
            "help_nav_secrets",
            (
                "Navegar por la lista de secretos",
        ...
        translations.insert(
            "help_show_hide",
            (
                "Mostrar u ocultar valores encriptados",
                "Show or hide encrypted values",
            ),
        );
        translations.insert(
            "help_zoom",
            (
                "Ver valor completo en modal con scroll",
                "View full value in modal with scroll",
            ),
        );
        translations.insert(
            "help_copy_value",
            (
                "Copiar valor del secreto al portapapeles",
        ...
        translations.insert(
            "help_copy_key",
            (
                "Copiar nombre de la clave al portapapeles",
        ...
        translations.insert(
            "help_favorite",
            (
                "Agregar/quitar archivo de favoritos",
                "Add/remove file from favorites",
            ),
        );
        translations.insert(
            "help_edit",
            ("Editar el secreto seleccionado", "Edit selected secret"),
        );
        translations.insert(
            "help_new",
            (
                "Agregar un nuevo secreto al archivo",
                "Add a new secret to file",
            ),
        );
        translations.insert(
            "help_delete",
            ("Eliminar el secreto seleccionado", "Delete selected secret"),
        );
        translations.insert(
            "help_save",
            (
                "Guardar cambios al archivo (re-encripta)",
                "Save changes to file (re-encrypts)",
            ),
        );
        translations.insert(
            "help_generate",
            (
                "Generar contraseña o token seguro",
                "Generate secure password or token",
            ),
        );
        translations.insert(
            "help_search_secrets",
            (
                "Buscar secretos por clave o valor",
                "Search secrets by key or value",
            ),
        );
        translations.insert(
            "help_back_explorer",
        ...
        translations.insert(
            "help_nav_keys",
            (
                "Navegar por las llaves disponibles",
                "Navigate through available keys",
            ),
        );
        translations.insert(
            "help_search_keys",
            (
                "Buscar llaves por nombre o clave pública",
                "Search keys by name or public key",
            ),
        );
        translations.insert(
            "help_apply_key",
            (
                "Usar la llave seleccionada para desencriptar",
                "Use selected key to decrypt",
            ),
        );
        translations.insert("help_cancel", ("Cancelar y cerrar", "Cancel and close"));
        translations.insert(
            "help_filter",
            ("Escribir para filtrar resultados", "Type to filter results"),
        );
        translations.insert("help_type", ("Escribir", "Type"));
        translations.insert(
            "help_apply_filter",
            ("Aplicar el filtro de búsqueda", "Apply search filter"),
        );
        translations.insert(
            "help_cancel_search",
            (
                "Cancelar búsqueda y limpiar filtro",
        ...
        translations.insert(
            "help_show_help",
            (
                "Mostrar u ocultar este panel de ayuda",
                "Show or hide this help panel",
            ),
        );
        ...
        translations.insert(
            "settings_theme_help",
            (
                "Cambia los colores de la interfaz (dark/light)",
                "Change interface colors (dark/light)",
            ),
        );
        translations.insert(
            "settings_language_help",
            (
                "Cambia el idioma de la aplicación (es/en)",
                "Change application language (es/en)",
            ),
        );
        translations.insert(
            "settings_autolock_help",
            (
                "Cierra archivos automáticamente tras inactividad (0=deshabilitado)",
                "Auto-close files after inactivity (0=disabled)",
            ),
        );
        translations.insert(
            "settings_timeout_help",
            (
                "Tiempo antes de limpiar portapapeles y ocultar mensajes",
                "Time before clearing clipboard and hiding messages",
            ),
        );
