...
pub fn show_help(i18n: &I18n) -> Vec<(String, Vec<(&'static str, String)>)> {
    vec![
        (
            i18n.t("help_explorer").to_string(),
            vec![
        ...
        (
            i18n.t("help_key_selector").to_string(),
            vec![
        ...
        (
            i18n.t("help_search").to_string(),
            vec![
                (
                    if i18n.t("help_type") == "Type" {
                        "Type"
                    } else {
                        "Escribir"
                    },
                    i18n.t("help_filter").to_string(),
                ),
